  ...
  <div class="faq-wrap">
    ...
    <details class="faq-item btn-hover-effect-dark" open>
      ...
      <div class="faq-content main-gray-color">
        <p>Выберите конструкцию и укажите размеры, тираж и опции. После расчёта добавьте позицию в корзину и заполните
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Производство: 2–7 рабочих дней (зависит от тиража и опций). Доставка по России курьером/ТК, самовывоз — по
          согласованию.</p>
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Оплата для физлиц и юрлиц/ИП. Онлайн-оплата картой или по счету — после
          подтверждения заказа со стороны менеджера. Все необходимые чеки и закрывающие документы предоставим.</p>
      </div>
    </details>
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Загрузите логотип/макет (SVG/PNG/PDF) в конфигураторе или позже. Для полноцветной печати цена согласуется
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Минимальный тираж — от 25 шт. Пробный образец возможен по согласованию и оплачивается отдельно.</p>
      </div>
    </details>
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Калькулятор покажет предварительный расчёт без цены на полноцвет — требуется проверка менеджером. Загрузите
    ...
    <details class="faq-item btn-hover-effect-dark">
      ...
      <div class="faq-content main-gray-color">
        <p>Сначала предложим ближайшие стандартные размеры (±80 мм) — это дешевле и быстрее. Если требуется свой размер,
