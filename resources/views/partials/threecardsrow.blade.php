    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
        ...
        <div class="main-3cards-block__card">
            ...
            <div class="main-3cards-block__card_title-zone">
                ...
                <p class="main-3cards-block__card_text">Изготовим необходимый именно вам размер</p>
            </div>
        </div>
        <div class="main-3cards-block__card">
            ...
            <div class="main-3cards-block__card_title-zone">
                ...
                <p class="main-3cards-block__card_text">Большой ассортимент различных коробов</p>
            </div>
        </div>
    </div>
</section>