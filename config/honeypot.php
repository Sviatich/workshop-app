...
use App\Http\Responders\HoneypotJsonResponder;
...
return [
     ...
     */
    // Use explicit names to let the frontend include them reliably
     ...
     */
    // Keep static to avoid guessing randomized names in JS
     ...
     */
    // Return JSON + 422 for API endpoints
    'respond_to_spam_with' => HoneypotJsonResponder::class,
